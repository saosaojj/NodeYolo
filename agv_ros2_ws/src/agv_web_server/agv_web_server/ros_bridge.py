# ROS2桥接模块，封装话题订阅/发布、服务调用和动作客户端，为Web服务器提供统一的ROS2通信接口
import threading
import time


# ROS2桥接类，管理订阅者、发布者、服务客户端和动作客户端，支持消息缓存和序列化缓存
class RosBridge:
    ...
    # 创建累积型话题订阅，按键字段将消息聚合存储，适用于多IO状态等场景
